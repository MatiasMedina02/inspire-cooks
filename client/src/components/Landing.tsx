...
const Landing = () => {
  return (
    <div className="w-full h-[550px] bg-gradient-to-b from-10% from-slate-200 to-orange-100 flex items-center justify-between p-20">
      <div className="w-2/3 flex flex-col relative z-10">
        ...
        <img className="w-[500px] h-[500px] rounded-full absolute right-10 bottom-10" src={FondoLanding} alt="Fondo Landing" />
    </div>
  );
};
